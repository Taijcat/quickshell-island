...
Rectangle {
 ...
 ColumnLayout {
  ...
  GridLayout {
    ...
    // Row 0: bars
    Bar { ratio: Math.max(0.1, cpuUsage); activeColor: Colors.blue; Layout.fillWidth: true; Layout.fillHeight: true }
    Bar { ratio: Math.max(0.1, gpuUsage); activeColor: Colors.green; Layout.fillWidth: true; Layout.fillHeight: true }
    Bar { ratio: Math.max(0.1, avgTemp); activeColor: Colors.red; Layout.fillWidth: true; Layout.fillHeight: true }
